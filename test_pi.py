...
def run_tests():
    evalset_path = os.path.join(os.path.dirname(__file__), 'specs', 'evalsets', 'professor-pi.evalset.json')
    ...
    for case in evalset['cases']:
        ...
        # We test the full orchestrator route which should delegate to pi for math
